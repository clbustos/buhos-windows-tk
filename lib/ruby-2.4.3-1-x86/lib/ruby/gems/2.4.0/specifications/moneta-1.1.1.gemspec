...
Gem::Specification.new do |s|
  ...
  s.email = ["mail@daniel-mendler.de".freeze, "wycats@gmail.com".freeze, "hannes.georg@googlemail.com".freeze, "asppsa@gmail.com".freeze]
  s.extra_rdoc_files = ["README.md".freeze, "SPEC.md".freeze, "LICENSE".freeze]
  s.files = ["LICENSE".freeze, "README.md".freeze, "SPEC.md".freeze]
  s.homepage = "http://github.com/moneta-rb/moneta".freeze
