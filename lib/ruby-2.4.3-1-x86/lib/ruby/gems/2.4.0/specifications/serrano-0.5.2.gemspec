...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<bundler>.freeze, [">= 2.0.2", "~> 2.0"])
      ...
      s.add_development_dependency(%q<webmock>.freeze, [">= 3.4.1", "~> 3.4"])
      s.add_runtime_dependency(%q<faraday>.freeze, ["~> 0.15.0"])
      s.add_runtime_dependency(%q<faraday_middleware>.freeze, ["< 0.14.0", ">= 0.12.2"])
      s.add_runtime_dependency(%q<multi_json>.freeze, [">= 1.13.1", "~> 1.13"])
      s.add_runtime_dependency(%q<thor>.freeze, ["~> 0.20.0"])
    else
      s.add_dependency(%q<bundler>.freeze, [">= 2.0.2", "~> 2.0"])
      ...
      s.add_dependency(%q<webmock>.freeze, [">= 3.4.1", "~> 3.4"])
      s.add_dependency(%q<faraday>.freeze, ["~> 0.15.0"])
      s.add_dependency(%q<faraday_middleware>.freeze, ["< 0.14.0", ">= 0.12.2"])
