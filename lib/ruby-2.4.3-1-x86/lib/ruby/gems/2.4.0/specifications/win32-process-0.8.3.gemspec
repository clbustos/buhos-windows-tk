# -*- encoding: utf-8 -*-
# stub: win32-process 0.8.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/djberg96/win32-process".freeze
  s.licenses = ["Artistic 2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new("> 1.9.0".freeze)
  s.rubygems_version = "2.6.14".freeze
  s.summary = "Adds and redefines several Process methods for MS Windows".freeze
