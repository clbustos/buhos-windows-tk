...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rubyzip>.freeze, [">= 1.2.1", "~> 1.2"])
      ...
      s.add_development_dependency(%q<kramdown>.freeze, [">= 1.16.2", "~> 1.16"])
      s.add_development_dependency(%q<timecop>.freeze, ["~> 0.8.1"])
    else
      s.add_dependency(%q<nokogiri>.freeze, [">= 1.8.2", "~> 1.8"])
      s.add_dependency(%q<rubyzip>.freeze, [">= 1.2.1", "~> 1.2"])
      ...
      s.add_dependency(%q<kramdown>.freeze, [">= 1.16.2", "~> 1.16"])
